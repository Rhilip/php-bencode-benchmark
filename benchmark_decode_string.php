...
function test_ridpt_bencode($count = 100000) {
    ...
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
        \Rid\Bencode\Bencode::decode($STRING);
    }
    return number_format(microtime(true) - $time_start, 3);
}
...
function test_sandfoxme_bencode($count = 100000) {
    ...
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
        \SandFox\Bencode\Bencode::decode($STRING);
    }
    return number_format(microtime(true) - $time_start, 3);
}
...
function test_rych_bencode($count = 100000) {
    ...
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
        \Rych\Bencode\Bencode::decode($STRING);
    }
    return number_format(microtime(true) - $time_start, 3);
}
...
function test_s9e_bencode($count = 100000) {
    ...
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
        \s9e\Bencode\Bencode::decode($STRING);
    }
    return number_format(microtime(true) - $time_start, 3);
}
...
function test_nrk_bencoder($count = 100000) {
    ...
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
        \Bencoder\Bencode::decode($STRING);
    }
    return number_format(microtime(true) - $time_start, 3);
}
...
function test_pure_bencode($count = 100000) {
    ...
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
        \PureBencode\Bencode::decode($STRING);
    }
    return number_format(microtime(true) - $time_start, 3);
}
...
function test_ppokatilo_bencode($count = 100000) {
    ...
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
        (new \SHyx0rmZ\Bencode\Decoder())->decode($STRING);
    }
    return number_format(microtime(true) - $time_start, 3);
}
...
function test_akatsuki_bencode($count = 100000) {
    ...
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
        (new \Akatsuki\Component\Bencode\Decoder())->decode($STRING);
    }
    return number_format(microtime(true) - $time_start, 3);
}
