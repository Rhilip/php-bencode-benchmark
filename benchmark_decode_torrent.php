...
function test_nexusphp_benc($count = 1000) {
    global $FILE_LOC;
...
function test_ridpt_bencode($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
...
function test_sandfoxme_bencode($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
...
function test_rych_bencode($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
...
function test_dsmithhayes_bencode($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
...
function test_s9e_bencode($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
...
function test_nrk_bencoder($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
...
function test_pure_bencode($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
...
function test_ppokatilo_bencode($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
...
function test_OPSnet_bencode_torrent($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
...
function test_akatsuki_bencode($count = 1000) {
    global $FILE_LOC;
    $time_start = microtime(true);
    for ($i=0; $i < $count; $i++) {
